...
| AST / parser | strong legacy oracle through `tests/selfhost` | AST summary type and parser token summary API are ported under `selfhost/src` | full AST data model and package runtime execution |
