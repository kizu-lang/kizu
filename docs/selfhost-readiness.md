...
| AST / parser | strong legacy oracle through `tests/selfhost` | AST node shapes plus parser summary/declaration snapshot APIs are ported under `selfhost/src` | real parser spans, parser detail snapshots, and package runtime execution |
