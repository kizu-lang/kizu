...
| AST / parser | strong legacy oracle through `tests/selfhost` | AST node shapes plus parser summary/declaration/detail APIs with token spans are ported under `selfhost/src` | package runtime execution |
