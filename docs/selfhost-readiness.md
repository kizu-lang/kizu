...
| AST / parser | strong legacy oracle through `tests/selfhost` | AST node shape types and parser token summary API are ported under `selfhost/src` | parser detail snapshots and package runtime execution |
