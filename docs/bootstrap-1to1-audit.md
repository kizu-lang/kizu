...
| IR | self-host IR summary plus normalized function/block/opcode/result/operand/immediate/terminator dump for selected pass/fail fixtures, including call opcode/result/argument type rows for simple user calls | weak | broaden to full instruction operand/value dump equality across conformance fixtures |
