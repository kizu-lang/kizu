...
| parser | self-host AST counts, declaration order, declaration detail, and selected control/expression node snapshots vs Go parser | weak | full AST node model and dump equality across all parseable conformance fixtures |
