...
| diagnostics | self-host diagnostic objects cover lexer, parser, resolver missing/visibility, type call/std-mem/borrow, and ownership move/borrow/mutable-borrow/field-borrow spans vs Go facts | weak | broaden to all checker diagnostics and all conformance failure classes |
