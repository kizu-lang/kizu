...
| diagnostics | self-host diagnostic objects cover lexer, parser, resolver missing/visibility, basic/control/variant and selected match/typed-error/unsafe/stdlib/concurrency type/call/std-mem/borrow, plus ownership move/borrow/mutable-borrow/field-borrow/deinit/Arena-Handle spans vs Go facts | weak | broaden to all checker diagnostics and all conformance failure classes |
