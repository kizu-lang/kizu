...
- [ADR-0076: public command owner transition](0076-public-command-owner-transition.md)
...
- [ADR-0080: selfhost はフル Kizu で書き、bootstrap の正は Go backend(stage0)に置く](0080-full-kizu-selfhost-and-stage0-boundary.md) (置換)
- [ADR-0081: 自己コンパイル backend を撤去し、backend は Go 参照実装の IR に合わせて作り直す](0081-remove-self-compiling-backend.md) (置換)
