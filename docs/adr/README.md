...
- [ADR-0016: 明示 lifetime annotation は採用しない](0016-no-explicit-lifetimes.md) (置換)
...
- [ADR-0059: explicit lifetime syntax for borrowed views](0059-explicit-lifetime-syntax.md)
