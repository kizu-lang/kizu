...
tags, so an example appears in more than one row. 188 runnable examples,
...
| wasm beyond the current target subsets | **in progress.** WASI WAT and binary routes run 166/188 runnable examples, browser binary runs 157/188, and all remaining cases are classified as target-unsupported capabilities |
