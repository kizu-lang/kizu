...
tags, so an example appears in more than one row. 191 runnable examples,
...
| wasm beyond the current target subsets | **in progress.** WASI WAT and binary routes run 169/191 runnable examples, browser binary runs 160/191, and all remaining cases are classified as target-unsupported capabilities |
