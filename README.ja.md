...
1 つの example は複数の行に現れます。runnable example は 185 件、測定は 2026-09-07 に
...
| 現在の subset を超える wasm backend | **進行中。** WASI WAT / binary は 165/185、browser binary は 156/185 が動き、残りはすべて target 非対応として分類済みです |
