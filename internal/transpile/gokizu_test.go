...
func TestGenerateCompilerDoesNotEmitGoDriver(t *testing.T) {
	...
	assertGeneratedSourceContains(t, outDir, "src/emit.kizu", "kizu selfhost source bytes")
	...
	assertGeneratedSourceContains(t, outDir, "src/emit.kizu", "fputc(i32 %ch, ptr %out.file)")
}
