...
func assertGeneratedParserSource(t *testing.T, outDir string) {
	...
	assertGeneratedSourceContains(t, outDir, "src/parser.kizu", "pub enum AstKind")
	assertGeneratedSourceContains(t, outDir, "src/parser.kizu", "pub struct AstNode")
	assertGeneratedSourceContains(t, outDir, "src/parser.kizu", "pub fn parse_ast")
	assertGeneratedSourceContains(t, outDir, "src/parser.kizu", "Function")
	assertGeneratedSourceContains(t, outDir, "src/parser.kizu", "ParamList")
	assertGeneratedSourceContains(t, outDir, "src/parser.kizu", "Block")
...
func assertGeneratedCheckerSource(t *testing.T, outDir string) {
	...
	assertGeneratedSourceContains(t, outDir, "src/checker.kizu",
		"valid: parsed >= 100 and balanced and ast_valid")
...
func assertGeneratedCompilerSource(t *testing.T, outDir string) {
	...
	assertGeneratedSourceContains(t, outDir, "src/parser.kizu", "ast_nodes: ast.node_count")
	...
	assertGeneratedSourceContains(t, outDir, "src/compiler.kizu", "metrics.ast_valid")
