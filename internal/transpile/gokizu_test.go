...
func assertGeneratedParserSource(t *testing.T, outDir string) {
	...
	assertGeneratedSourceContains(t, outDir, "src/parser.kizu", "top_functions: top_functions")
	assertGeneratedSourceContains(t, outDir, "src/parser.kizu",
...
func assertGeneratedCheckerSource(t *testing.T, outDir string) {
	...
	assertGeneratedSourceContains(t, outDir, "src/checker.kizu", "top_functions: top_functions")
...
func assertGeneratedCompilerSource(t *testing.T, outDir string) {
	...
	assertGeneratedSourceContains(t, outDir, "src/parser.kizu", "top_imports: top_imports")
	...
	assertGeneratedSourceContains(t, outDir, "src/compiler.kizu", "metrics.top_functions")
