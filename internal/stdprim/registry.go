...
var SimpleCoreSignatures = map[string]CoreSignature{
	...
	"std::internal::builtin::mem_compare":        {Args: []ArgKind{ArgBytes, ArgBytes}, Return: "i64"},
	...
	"std::internal::builtin::f64_sqrt":           {Args: []ArgKind{ArgF64}, Return: "f64"},
