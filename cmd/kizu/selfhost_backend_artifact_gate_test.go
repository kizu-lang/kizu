...
func requiredLLVMExecutableFragments() []string {
	return []string{
		...
		"define %kizu.selfhost.codegen.run_ast @kizu_selfhost__cli_codegen_parse_checked_run_ast",
		"define %kizu.selfhost.codegen.program @kizu_selfhost__cli_codegen_lower_run_ast",
		"define %kizu.selfhost.codegen.binding @kizu_selfhost__cli_codegen_parse_let_binding",
		"define %kizu.selfhost.codegen.payload @kizu_selfhost__cli_codegen_parse_print_statement",
